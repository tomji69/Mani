...
text= "💙💚❤️THIS WEB PAGE IS MADE BY KING MANI 💫💯🟥🟨🟧OWNER :- KING MANI ✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 KING MANI ✨</h1>
            <h3>OWNER BY KING MANI ❤️</h3>
          </header>
          ...
          <footer class="footer">
            <p>&copy; Developed by King Mani 2025. All Rights Reserved.</p>
